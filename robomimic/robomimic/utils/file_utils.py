...
def algo_name_from_checkpoint(ckpt_path=None, ckpt_dict=None):
    ...
    """
    #print(f"Checkpoint dickt:", ckpt_dict.keys())
    #print(f"Checkpoint dickt:", ckpt_dict["cfg"])
    #print(f"Checkpoint state dict:", ckpt_dict["state_dicts"])
    #print(f"Checkpoint pickle:", ckpt_dict["pickles"])
